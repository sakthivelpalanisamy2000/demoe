...
var SimpleBar = (function () {
  ...
  var j = function (t, e, i) {
      ...
      return (
        ...
        T(i) &&
          ((h = !!i.leading),
          (r = (d = "maxWait" in i) ? V(D(i.maxWait) || 0, e) : r),
  ...
  var P = function (t, e, i) {
      ...
      return (
        ...
        B(t, e, { leading: s, maxWait: e, trailing: l })
      );
    },
    X = function () {
      return (
  ...
  i &&
    window.addEventListener("resize", function () {
      _ !== window.devicePixelRatio &&
        ((_ = window.devicePixelRatio), (Y = null));
    });
  var U = function (t) {
    ...
    Z = (function () {
      function t(e, i) {
        ...
        if (
                  ...
                  null !==
                    (l =
                      null === (i = v.rect) || void 0 === i
                        ? void 0
                        : i[s.axis[s.draggedAxis].sizeAttr]) && void 0 !== l
                    ? l
                    : 0,
          ...
          (this.el = e),
          (this.options = X(X({}, t.defaultOptions), i)),
          (this.classNames = X(
            X({}, t.defaultOptions.classNames),
            i.classNames
          )),
          (this.axis = {
            x: {
        ...
        (this.onMouseMove = P(this._onMouseMove, 64)),
          (this.onWindowResize = j(this._onWindowResize, 64, { leading: !0 })),
          (this.onStopScrolling = j(
            this._onStopScrolling,
            this.stopScrollDelay
          )),
          (this.onMouseEntered = j(this._onMouseEntered, this.stopScrollDelay)),
          this.init();
      }
      return (
        ...
        (t.prototype.initDOM = function () {
          ...
          (this.wrapperEl = this.el.querySelector(
            ...
            this.options.autoHide ||
              (null === (i = this.axis.x.scrollbar.el) ||
                void 0 === i ||
                i.classList.add(this.classNames.visible),
              null === (s = this.axis.y.scrollbar.el) ||
                void 0 === s ||
        ...
        (t.prototype.recalculate = function () {
          if (
            ...
            (this.axis.x.isOverflowing =
              this.axis.x.isOverflowing && a > l - d),
              (this.axis.y.isOverflowing =
        ...
        (t.prototype.getScrollbarSize = function (t) {
          ...
          var s,
            ...
            o = r / l;
          return (
            (s = Math.max(~~(o * r), this.options.scrollbarMinSize)),
          ...
          if (
            ...
            (c =
              ...
              "x" === e &&
                this.isRtl &&
                (c = (
                  null === (l = t.getRtlHelpers()) || void 0 === l
                    ? void 0
                    : l.isScrollingToNegative
                )
                  ? c
                  : -c);
            var h = c / (o - a),
          ...
          if (
            ...
            var c =
              ...
              h = parseInt(
                null !==
                  (r =
                    null === (l = this.elStyles) || void 0 === l
                      ? void 0
                      : l[this.axis[e].sizeAttr]) && void 0 !== r
                  ? r
                  : "0px",
                10
              ),
      ...
      return (
        ...
        (i.prototype.initDOM = function () {
          ...
          if (!this.axis.x.track.el || !this.axis.y.track.el) {
            ...
            l.classList.add(this.classNames.track),
