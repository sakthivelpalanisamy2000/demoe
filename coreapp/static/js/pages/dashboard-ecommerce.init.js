  ...
  layoutRightSideBtn =
    (vectorMapWorldLineColors &&
      (worldlinemap = new jsVectorMap({
        ...
        lines: [
          { from: "Canada", to: "Serbia" },
          { from: "Russia", to: "Serbia" },
          { from: "Greenland", to: "Serbia" },
          { from: "Brazil", to: "Serbia" },
          { from: "United States", to: "Serbia" },
          { from: "China", to: "Serbia" },
          { from: "Norway", to: "Serbia" },
          { from: "Sydney", to: "Serbia" },
        ],
        regionStyle: {
          initial: {
            stroke: "#9599ad",
      ...
      (Array.from(document.querySelectorAll(".layout-rightside-btn")).forEach(
        function (e) {
          ...
          e.addEventListener("click", function () {
            document
              .querySelectorAll(".layout-rightside")
              .forEach(function (e) {
  ...
  document.querySelectorAll(".chat-panel-list li").forEach(function (r) {
    r.addEventListener("click", function () {
      ...
      var e = r.querySelector(".chatlist-user-name").innerHTML,
        ...
        e =
          ((document.querySelector(".chat-topbar .profile-username").innerHTML =
            e),
          document
            .querySelector(".chat-topbar .userprofile")
            .setAttribute("src", t),
                ...
                : (document
                    ...
                    .insertAdjacentHTML(
                      ...
                      '<li class="chat-list right">        <div class="conversation-list">            <div class="user-chat-content">                <div class="ctext-wrap">                    <div class="ctext-wrap-content">                        <p class="mb-0 ctext-content">' +
                        ...
                        currentTime() +
                        '</small> <span class="text-muted check-message-icon"><i class="ri-check-line align-bottom"></i></span></div>            </div>        </div>    </li>'
                    ),
...
searchInput.addEventListener("keyup", function () {
  var a,
    e = searchInput.value.length,
    t = document.querySelectorAll(".chat-panel-list .list-group-item");
  0 < e
    ? ((a = searchInput.value.toLowerCase()),
      Array.from(t).forEach(function (e) {
        var t,
          r,
          o = "";
        e.querySelector(".chatlist-user-name")
          ? ((t = e.querySelector(".chatlist-desc").innerText.toLowerCase()),
            (o = (r = e
              .querySelector(".chatlist-user-name")
              .innerText.toLowerCase()).includes(a)
              ? r
              : t))
          : e.querySelector(".chatlist-desc") &&
            (o = e.querySelector(".chatlist-desc").innerText.toLowerCase()),
          console.log(o),
          o &&
            (o.includes(a)
