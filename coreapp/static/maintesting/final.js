  ...
  function (e, t, o) {
      ...
      (function (e, t) {
        ...
        const o = () => {
          $(".mobile-run-button #loader").replaceWith(a),
            ...
            $(".mobile-top-bar-run-button").html(
        ...
        l() || p()
          ? (console.log("Opening sale popup"),
            ...
            $(".sale-popup a#claim-discount")
              ...
              .attr(
                "href",
                "https://programiz.pro/offer/cyber-monday?utm_source=popup-compiler&utm_medium=popup&utm_campaign=cybermonday-sale__popup-compiler__nov__60"
              ),
            void (document.getElementById("sale-popup").style.display = "flex"))
          : (console.log("Opening default popup"), void s())
      ),
      G = () => {
        $("span.run-text").replaceWith("run"
        ...
        // ),
        //   $(".mobile-top-bar-run-button").html(
        //     '<svg id="mobile-top-bar-run-button-loader" width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n                        <circle cx="12" cy="12" r="10" stroke="white" stroke-opacity="0.6" stroke-width="4"/>\n                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 12C0 5.37258 5.37258 0 12 0V4C7.58172 4 4 7.58172 4 12C4 12.3387 4.02104 12.6724 4.06189 13H0.0410728C0.0138702 12.6703 0 12.3368 0 12Z" fill="white"/>\n                      </svg>    \n'
          );
      },
      D = (e) => {
        (() => {
    ...
    $(".shell-pill").click(() => {
      ...
      $(".desktop-save-button").on("click", () => {
        w === i.SUPPORTED_LANGUAGES.PYTHON &&
          window.confirm(
            "Redirecting you to our new Python IDE that supports saving, sharing, working with files & installing packages."
          ) &&
          window.open(
            "https://programiz.pro/ide/python?utm_source=compiler-nav-save&utm_medium=referral&utm_campaign=programiz",
            "_blank"
          ),
          w === i.SUPPORTED_LANGUAGES.C &&
            window.confirm(
              "Redirecting you to our new C IDE that supports saving, sharing and working with files."
            ) &&
            window.open(
              "https://programiz.pro/ide/c?utm_source=compiler-nav-save&utm_medium=referral&utm_campaign=programiz",
              "_blank"
            );
      });
  },
